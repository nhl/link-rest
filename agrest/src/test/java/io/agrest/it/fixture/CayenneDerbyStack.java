...
public class CayenneDerbyStack extends ExternalResource {
    ...
    public int intForQuery(String querySql) {
        Number result = SQLSelect.scalarQuery(Integer.class, querySql).selectOne(newContext());
        return result != null ? result.intValue() : -1;
    }

    public long longForQuery(String querySql) {
        Number result = SQLSelect.scalarQuery(Long.class, querySql).selectOne(newContext());
